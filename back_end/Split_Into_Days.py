...
def calculate_daily_cosine_sim(DEVICE_ID, outer_arr):
	"""
	Computes and write list of top 10 similar device+day combination for whole 5 months for the device_id received
	@param DEVICE_ID: device id
	...
	for x in range(0, len(outer_arr)):
		...
		if (inner_dict_obj["device_id"] == DEVICE_ID):  # For this device we iterate on whole 5 months
